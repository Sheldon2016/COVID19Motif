...
#define Monomorphism 1  /* Added by Jiafeng Hu */
...
VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::VF3SubState(
        ARGraph<Node1, Edge1> *ag1, ARGraph<Node2, Edge2> *ag2, int *class_1, int *class_2, int nclass,
        node_id *order) {
...
void VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor,
        EdgeComparisonFunctor>::UpdateTerminalSetSize(node_id node, node_id level, bool *in_1, bool *out_1,
                                                      bool *inserted) {
...
template<typename Node1, typename Node2,
        ...
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
void
VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::ComputeFirstGraphTraversing() {
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
bool VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::NextPair(node_id *pn1,
                                                                                                     node_id *pn2,
                                                                                                     node_id prev_n1,
                                                                                                     node_id prev_n2) {
...
template<typename Node1, typename Node2,
        ...
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
bool
VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::IsFeasiblePair(node_id node1,
                                                                                                      node_id node2) {
    //std::cout<<"\nIF: " <<node1<<" " << node2;
    ...
    /*monomorphism version, updated by jiafeng*/
#else
    if (termin1[core_len] + termout1[core_len] + new1[core_len] <= termin2 + termout2 + new2) {
        for (i = 0; i < classes_count; i++) {
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
void VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::AddPair(node_id node1,
                                                                                                    node_id node2) {
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
void VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::GetCoreSet(node_id c1[],
                                                                                                       node_id c2[]) {
    int i, j;
    for (i = 0, j = 0; i < n1; i++)
...
VF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::GetParent() {
