...
x = [1	2	3	4	5];
y1 = [0.341	0.5	2.6	2.4	7.19
];
y2 = [4.28	3.331	15.1	22.9	27.8

];
y3 = [6.939	8.682	31.581	92.182	56.138];
y4 = [7.1	12.229	47.4	175.7	82.5];
...
set(gca,'YTickLabel',{'10^{-1}' '1' '10' '10^2' '10^3'})
...
print(fig,'C:\Users\jhu\Dropbox\Recent works\collaboration on motif\VLDB-submission\figures\varyResultNum-instacart.pdf','-dpdf');
