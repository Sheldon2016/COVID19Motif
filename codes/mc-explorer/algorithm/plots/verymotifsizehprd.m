...
x = [1	2	3	4	5];
y1 = [0.007	0.015	0.02	0.006	0.019];
y2 = [0.012	0.027	0.023	0.006	0.023];
y3 = [0.022	0.032	0.024	0.007	0.03];
y4 = [0.036	0.217	0.032	0.01	0.068];
...
set(gca,'YTickLabel',{'10^{-3}' '10^{-2}' '10^{-1}' '1' '10' '10^2' 'Inf'})
...
print(fig,'C:\Users\jhu\Dropbox\Recent works\collaboration on motif\VLDB-submission\figures\varymotifsize-hprd.pdf','-dpdf');
