...
public:
    VF2State(ARGraph<Node1, Edge1> *g1, ARGraph<Node2, Edge2> *g2, node_id *order = NULL);
...
VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::VF2State(ARGraph<Node1, Edge1> *ag1,
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::VF2State(const VF2State &state) {
    g1 = state.g1;
    g2 = state.g2;
    n1 = state.n1;
    n2 = state.n2;
...
template<typename Node1, typename Node2,
        ...
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
bool
VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::NextPair(node_id *pn1, node_id *pn2,
                                                                                             node_id prev_n1,
                                                                                             node_id prev_n2) {
...
bool VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::IsFeasiblePair(node_id node1,
                                                                                                        node_id node2) {
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
void VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::AddPair(node_id node1,
                                                                                                 node_id node2) {
    assert(node1 < n1);
    assert(node2 < n2);
    assert(core_len < n1);
...
template<typename Node1, typename Node2,
        typename Edge1, typename Edge2,
        typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
void VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::GetCoreSet(node_id c1[],
                                                                                                    node_id c2[]) {
    int i, j;
    for (i = 0, j = 0; i < n1; i++)
